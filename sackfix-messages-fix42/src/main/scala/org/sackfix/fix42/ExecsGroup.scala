...
/**
  ...
  */
case class ExecsGroup(lastSharesFloatField:Option[LastSharesFloatField]=None,
...
object ExecsGroup extends SfGroupDecoder {
  ...
  override val OptionalFields = HashSet[Int](
    LastSharesFloatField.TagId, ExecIDField.TagId, LastPxField.TagId, LastCapacityField.TagId)
  ...
  override def isFirstField(tagId:Int) : Boolean = tagId==LastSharesFloatField.TagId 
  ...
  def decodeSingle(flds: Seq[Tuple2[Int, Any]], startPos:Int):Tuple2[Int,Option[ExecsGroup]] = {
    if (!isFirstField(flds(startPos)._1)) (startPos, None)
      ...
      if (myFields.nonEmpty) {
        (pos,Some(ExecsGroup(myFields.get(LastSharesFloatField.TagId).flatMap(f=>LastSharesFloatField.decode(f)),
